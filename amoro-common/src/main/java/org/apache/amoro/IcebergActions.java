...
public class IcebergActions {
  ...
  public static final HashMap<String, Action> actions;
  ...
  public static final Action EXPIRE_SNAPSHOT = new Action(DEFAULT_FORMATS, 2, "expire-snapshot");

  static {
    actions = new HashMap<>();
    actions.put("expire-snapshot", IcebergActions.EXPIRE_SNAPSHOT);
  }
}
