...
public class IcebergDeleteFilesOutput extends DeleteFilesOutput {

  private final DeleteFile[] deleteFiles;
  private final Map<String, String> deleteSummary;

  public IcebergDeleteFilesOutput(
      String catalog,
      String database,
      String table,
      MaintainerType type,
