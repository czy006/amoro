...
public class TestPaimonExecutorIntegration {
  ...
  @Test
  @DisplayName(
      "executeTask with Paimon factory should return error result with UnsupportedOperationException")
  void testPaimonExecuteTaskReturnsError() {
    ...
    assertTrue(result.getErrorMessage().contains("UnsupportedOperationException"));
  }
}
